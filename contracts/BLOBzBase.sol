...
contract BLOBzBase is ERC721A, Ownable {

    // config
    constructor() ERC721A("BLOBz Base", "BLOBZASE") {}
    ...
    string public baseURI = "ipfs://bafybeieuhf75q6zkjrv77zkoxivty7tqyr67zmjaqct7aax5z4jdb54qh4/2_base.gif";
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        string memory jsonPreImage = string.concat(
            string.concat(
                string.concat('{"name": "BLOBz Base #', Strings.toString(tokenId)),
