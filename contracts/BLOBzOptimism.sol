...
contract BLOBzOptimism is ERC721A, Ownable {

    // config
    constructor() ERC721A("BLOBz Optimism", "BLOBZOP") {}
    ...
    string public baseURI = "ipfs://bafybeieuhf75q6zkjrv77zkoxivty7tqyr67zmjaqct7aax5z4jdb54qh4/1_op.gif";
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        string memory jsonPreImage = string.concat(
            string.concat(
                string.concat('{"name": "BLOBz Optimism #', Strings.toString(tokenId)),
