...
contract BLOBzMode is ERC721A, Ownable {

    // config
    constructor() ERC721A("BLOBz Mode", "BLOBZODE") {}
    ...
    string public baseURI = "ipfs://bafybeieuhf75q6zkjrv77zkoxivty7tqyr67zmjaqct7aax5z4jdb54qh4/4_mode.gif";
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        string memory jsonPreImage = string.concat(
            string.concat(
                string.concat('{"name": "BLOBz Mode #', Strings.toString(tokenId)),
